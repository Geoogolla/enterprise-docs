...
On exporting the report, the visibility of the sparkline can be controlled using the `Output` property. The **Auto** or **Output** options in the dropdown enables the sparkline report item to be exported. Choosing **NoOutput** will not export the sparkline report item.
