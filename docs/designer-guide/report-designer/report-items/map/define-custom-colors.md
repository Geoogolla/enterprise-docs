...
<img style="width:540px" src="/assets/on-premise/images/report-designer/report-items/map/custom-colors/custom-colors-field.png" alt="Map custom color field">
2. Then click on the edit icon for the `Custom Colors` property.
<img style="width:540px" src="/assets/on-premise/images/report-designer/report-items/map/custom-colors/edit-icon.png" alt="Edit analytical and spatial link">
3. Now, you will be taken to the **Map Custom Colors** panel.
<img style="width:540px" src="/assets/on-premise/images/report-designer/report-items/map/custom-colors/panel.png" alt="Edit analytical and spatial link">
4. Click on the **ADD** icon in the top-right corner. A new field with option to set color will be added in the panel.
<img style="width:540px" src="/assets/on-premise/images/report-designer/report-items/map/custom-colors/add-field.png" alt="Add new binding expression">
5. Set the desired color in the color field.
<img style="width:540px" src="/assets/on-premise/images/report-designer/report-items/map/custom-colors/set-color.png" alt="Set color">
...
<img style="width:540px" src="/assets/on-premise/images/report-designer/report-items/map/custom-colors/expression-menu.png" alt="Expression menu">
...
<img style="width:540px" src="/assets/on-premise/images/report-designer/report-items/map/custom-colors/multiple-colors-in-design.png" alt="Multiple colors">
...
<img style="width:540px" src="/assets/on-premise/images/report-designer/report-items/map/custom-colors/marker-color-rule.png" alt="Marker multiple colors">
...
<img style="width:540px" src="/assets/on-premise/images/report-designer/report-items/map/custom-colors/delete-custom-colors.png" alt="Delete binding expression">