...
2. Enter the description of the dataset.
3. Click `Browse` and select the `.rsd` file to upload. The `Name` field of the dataset is auto-filled with the uploaded `.rsd` file name.
