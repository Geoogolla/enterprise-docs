...
6. [Click here](https://raw.githubusercontent.com/boldreports/bold-reports-azure/master/armtemplates/v5.1.20/BoldReportsAppServiceTemplate.json)  to download the ARM template file.
