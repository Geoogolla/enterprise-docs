...
6. [Click here](https://raw.githubusercontent.com/boldreports/bold-reports-azure/master/armtemplates/v3.3.23/BoldReportsAppServiceTemplate.json) to download the ARM template file.
