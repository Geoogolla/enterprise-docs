...
6. [Click here](https://raw.githubusercontent.com/boldreports/bold-reports-azure/master/armtemplates/v4.2.52/BoldReportsAppServiceTemplate.json) to download the ARM template file.
