...
* Create the Bold Reports Report Server Azure App Service by following this [link](./../../../installation/deploy-in-azure-app-service/using-arm-template/) and also configure the application using the database by following this [link](./../../../installation/deploy-in-azure-app-service/using-arm-template/#configure-a-new-bold-reports).
