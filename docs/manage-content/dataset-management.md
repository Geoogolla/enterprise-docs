...
* To create dataset, we have use datasource either newly created or else existing datasource. Refer this link for [creating dataset](/on-premise/manage-content/data-sources-management/#add-or-create-data-sources)
...
<table>
    ...
    <tr>
        <td>
            <a href="https://help.boldreports.com/on-premise/rest-api-reference/v1.0/#operation/Items_AddDataSet">AddDataset</a>
        </td>
        <td>
            POST
        </td>
    ...
    <tr>
        <td>
            <a href="https://help.boldreports.com/on-premise/rest-api-reference/v1.0/#operation/Items_UpdateDataSet">UpdateDataset</a>
        </td>
        <td>
            PUT
        </td>
        ...
        <tr>
        <td>
            <a href="https://help.boldreports.com/on-premise/rest-api-reference/v1.0/#operation/Items_GetItems">GetDataSets</a>
        </td>
        <td>
            GET
        </td>
        ...
        <tr>
        <td>
            <a href="https://help.boldreports.com/on-premise/rest-api-referencei/v1.0/#operation/Items_GetItemLocation">GetDataSetLocation</a>
        </td>
        <td>
            GET
        </td>
    ...
    <tr>
        <td>
            <a href="https://help.boldreports.com/on-premise/rest-api-reference/v1.0/#operation/Items_IsItemNameExists">IsDataSetNameExists</a>
        </td>
        <td>
            POST
        </td>
    ...
    <tr>
        <td>
            <a href="https://help.boldreports.com/on-premise/rest-api-reference/v1.0/#operation/Items_GetItemDetail">GetDataSetDetail</a>
        </td>
        <td>
            GET
        </td>
        ...
        <tr>
        <td>
            <a href="https://help.boldreports.com/on-premise/rest-api-reference/v1.0/#operation/Items_DeleteItem">DeleteDataSet</a>
        </td>
        <td>
            DELETE
        </td>
