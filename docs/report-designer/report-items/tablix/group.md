...
After creating groups, the group properties such as [filters](/on-premise/report-designer/compose-report/filter-data/), [sort](/on-premise/report-designer/compose-report/sort-data/), and [groups expressions](/on-premise/report-designer/compose-report/group-data/) can be modified to organize the data visualization of the respective group in data region. To edit an existing group, select the respective member in the Row or Column Groups pane of the grouping panel. Now, the respective member properties will be listed in the properties panel.
...
Refer [Group properties](/on-premise/report-designer/report-items/tablix/member-properties/#group-member-properties) section and modify the group properties.
...
To understand the visual cues in grouping panel, refer the [Grouping Panel Visual Cues](/on-premise/report-designer/report-items/tablix/grouping-panel/#visual-cues) section.
