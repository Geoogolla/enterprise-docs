...
4. Choose an **Authentication Type** supported by the data source. Options are `Basic http authentication` and `None`. Learn more about [Authentication Types](/on-premise/report-designer/manage-data/data-connectors/rest-api-data-source/#authentication-types).
