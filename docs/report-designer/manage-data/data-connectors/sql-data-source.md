...
3. In the connection type panel, choose the `SQL` data source type.
   ![Connection types panel](/static/assets/on-premise/images/report-designer/manage-data/data-connectors/connection-types.png)
...
3. In [Authentication Type](/on-premise/report-designer/manage-data/data-connectors/sql-data-source/#authentication-types-for-basic-connection) field, choose **Windows** or **SQL Server** authentication.
...
Connect to the SQL Server database with [Basic Options](/on-premise/report-designer/manage-data/data-connectors/sql-data-source/#create-microsoft-sql-server-data-source-with-basic-options) or [Advanced Options](/on-premise/report-designer/manage-data/data-connectors/sql-data-source/#create-microsoft-sql-server-data-source-with-advanced-options).
...
![New connection panel](/static/assets/on-premise/images/report-designer/manage-data/data-connectors/stored-parameters.png)
...
[Query Expression](/on-premise/report-designer/transforming-data/configure-expression-columns/)