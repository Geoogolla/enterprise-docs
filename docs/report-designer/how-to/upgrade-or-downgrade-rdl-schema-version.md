...
2. Open [Report Properties](/report-designer/compose-report/report-properties/). Under `Miscellaneous` category, choose the target version in `Version` property drop-down.
