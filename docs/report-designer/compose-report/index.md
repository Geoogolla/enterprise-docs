...
Refer [Toolbar](/on-premise/report-designer/compose-report/tool-bar/) section to handle the options in toolbar.
...
Refer [Properties panel](/on-premise/report-designer/compose-report/properties-panel/) section to set and style report items.
...
Refer [Report item multiselection](/on-premise/report-designer/compose-report/report-item-multi-selection/) section to edit properties of multiple report items.
...
Refer [Filter data](/on-premise/report-designer/compose-report/filter-data/) section to add or remove filters in report.
...
Refer [Sort data](/on-premise/report-designer/compose-report/sort-data/) section to control the order the data either in ascending or descending.
...
Refer [Group data](/on-premise/report-designer/compose-report/sort-data/) section display data in a hierarchy view.
...
Refer [Report linking](/on-premise/report-designer/compose-report/link-data/#report-linking) section to specify the drill through report path.
...
Refer [Hyperlink](/on-premise/report-designer/compose-report/link-data/#hyperlink) section to set hyperlink actions to text boxes, images, charts, and tablix.
...
Refer [Drilldown action](/on-premise/report-designer/compose-report/create-ssrs-drill-down-report/) section to handle drilldown properties in designer.

## Expression builder

Report Designer provides an expression builder that allows you to create simple and complex RDL expressions.

Refer [Expressions](/on-premise/report-designer/compose-report/expressions/) section to create expressions in expression builder.
...
Refer [Format data](/on-premise/report-designer/compose-report/format-data/) section to handle formatting for data.

## Unit switcher

You can switch the unit type in the report, to convert from one unit type to another.

Refer [Unit switcher](/on-premise/report-designer/compose-report/unit-switcher/) section to switch the unit type in the report.
...
Refer [Code module](/on-premise/report-designer/compose-report/code-module/) section to add and handle custom code in report.