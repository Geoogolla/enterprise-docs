...
2. Provide your [Database details](/on-premise/application-startup/#database-configuration-for-bold-reports-sites) to maintain your user identities and Bold Reports tenants and click `Next`.
...
3. Provide the [user details](/on-premise/application-startup/#new-user---system-administrator) and this user will be an admin for Bold Reports, and then click `Next`.
...
4. Provide your [Database details](/on-premise/application-startup/#database-configuration-for-bold-reports-server) to maintain your reports, users, and their access permissions, and then click `Next`.
