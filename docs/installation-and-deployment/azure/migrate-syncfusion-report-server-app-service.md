...
* Create the Bold Reports Report Server Azure App Service by following this [link](/on-premise/installation-and-deployment/azure/create-app-service/) and also configure the application using the database by following this [link](/on-premise/installation-and-deployment/azure/create-app-service/#configure-a-new-bold-reports).
